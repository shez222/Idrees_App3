...
// If your TradingWidget is in a separate file, adjust the path accordingly
...
// Lottie assets
import computer from '../../assets/Animation - 1742778989284.json';
import bulb from '../../assets/Animation - 1742779118859.json';
import reader from '../../assets/Animation - 1742778920158.json';
...
const MarketPage = () => {
  ...
  // For narrower devices, shrink header width
  ...
  const headerComponent = useMemo(() => {
    return (
      <>
        ...
        {/* Conditionally show TradingWidget ONLY if there's no search query */}
        {!searchQuery && <TradingWidget />}
      </>
    );
  }, [
    currentTheme,
